...
export const moduleConfigs: Record<OperationalModule, ModuleConfig> = {
  products: {
    ...
    description: "Create products with opening stock, pricing, sourcing, warehouse location, and reorder controls.",
    singular: "product",
    referenceLabel: "SKU",
    titleLabel: "Product name",
    statusOptions: ["active", "inactive"],
    createLabel: "Add product",
    quantityLabel: "Reorder level",
  ...
  suppliers: {
    ...
    description: "Manage supplier companies, contacts, locations, payment terms, ratings, and status.",
    singular: "supplier",
