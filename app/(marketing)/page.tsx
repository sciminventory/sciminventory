...
export default function Home() {
  return (
    <main className="overflow-hidden">
      <ScrollMotion />
      <MarketingHeader />
      <section className="relative bg-paper pb-24 pt-36 sm:pt-44">
        ...
        <div className="shell relative text-center">
          <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-ink/10 bg-white/70 px-3 py-1.5 font-mono text-[9px] font-medium uppercase tracking-[.09em] shadow-sm backdrop-blur">
            <span className="size-1.5 rounded-full bg-accent ring-4 ring-accent/20" />{" "}
            Built for real operational work <ArrowUpRight size={11} />
          </div>
          <h1 className="text-balance mx-auto mt-7 max-w-5xl text-[clamp(3rem,8vw,6.9rem)] font-bold leading-[.9] tracking-[-.075em]">
            Your supply chain,
            <br />
