      ...
      <section className="relative overflow-hidden border-b border-line pb-20 pt-36 sm:pt-44">
        ...
        <div className="shell relative">
          <ScrollReveal distance={18}>
            <span className="inline-flex items-center gap-2 rounded-full border border-blue-100 bg-white px-3 py-1.5 font-mono text-[9px] uppercase tracking-[.1em] text-blue-700"><Sparkles size={11} /> Careers</span>
...
function Pill({ children }: { children: React.ReactNode }) { return <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-50 px-3 py-1.5 text-[9px] font-medium text-blue-700">{children}</span>; }
